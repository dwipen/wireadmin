...
return [
    ...
    */
    'override' => [
      ...
      'adminlte.logo' => 'site.name',
      'adminlte.logo_img' => 'site.logo',
      'mail.mailers.smtp.host' => 'marketing.mail_host',
      'mail.mailers.smtp.port' => 'marketing.mail_port',
      'mail.mailers.smtp.encryption' => 'marketing.mail_encryption',
      'mail.mailers.smtp.username' => 'marketing.mail_username',
      'mail.mailers.smtp.password' => 'marketing.mail_password',
      'mail.from.address' => 'marketing.mail_from_address',
      'mail.from.name' => 'marketing.mail_from_name',

      'activitylog.enabled' => 'site.activitylog',

      'paypal.mode' => 'payment.paypal_mode',
      'paypal.currency' => 'payment.currency',
      'paypal.sandbox' => 'payment.credentials',
      'paypal.live' => 'payment.credentials',
